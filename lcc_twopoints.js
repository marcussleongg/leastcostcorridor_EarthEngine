...
function three_multiraster_lcc(startPoint, endPoint) {
  ...
  Map.addLayer(startEndAddedCost2, {}, 'clipped cost');
  ...
  Map.addLayer(startEndAddedCost3, {}, 'clipped cost2');
  ...
  Map.addLayer(startEndStyledPath, {}, 'Least-Cost Path (Styled Vector) Part');
}
...
three_multiraster_lcc(point1, point2);
...
three_multiraster_lcc(point2, point3);
...
three_multiraster_lcc(point3, point4);
